		...
		<!-- Header -->
			<div id="header">
				...
				<div class="top">
					...
					<!-- Logo -->
						<div id="logo">
							<span class="image avatar48"><img src="images/pexels-realtoughcandy-11035390.jpg" alt="" /></span>
							<h1 id="title">Sébastien Auclère</h1>
							<p>Développeur Web</p>
						</div>
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li><a href="#about" id="about-link"><span class="icon solid fa-user">A propos de moi</span></a></li>
				...
				<!-- Intro -->
					<section id="top" class="one dark cover">
						<div class="container">
							...
							<header>
								<h2 class="alt">Salut! ceci est mon <strong>Portfolio</strong>, un site responsive<br />
								réalisé grâce a un super template récupéré sur <a href="http://html5up.net">HTML5 UP</a>.</h2>
								<p>Il y a ici un condensé sur mon travail réalisé<br />
								depuis que je bosse sur le développement pour ma reconversion.</p>
							</header>

							<footer>
								<a href="#portfolio" class="button scrolly">Mon portfolio</a>
							</footer>
						...
						<div class="container">
							...
							<div class="row">
								<div class="col-4 col-12-mobile">
									<article class="item">
										<a href="#" class="image fit"><img src="images/pexels-alesiakozik-6770611.jpg" alt="" /></a>
										<header>
											<h3>Formation bitcoins</h3>
										</header>
									</article>
									<article class="item">
										<a href="#" class="image fit"><img src="images/pexels-fotios-photos-16129703.jpg" alt="" /></a>
										<header>
											<h3>php / HTML</h3>
										</header>
									</article>
								...
								<div class="col-4 col-12-mobile">
									<article class="item">
										<a href="#" class="image fit"><img src="images/pexels-thisisengineering-3861959.jpg" alt="" /></a>
										<header>
								...
								<div class="col-4 col-12-mobile">
									...
									<article class="item">
										<a href="#" class="image fit"><img src="images/pexels-peaky-29445974.jpg" alt="" /></a>
										<header>
											<h3>Authenticité</h3>
										</header>
									</article>
						...
						<div class="container">
							...
							<form method="post" action="traitement-contact.php" id="monformulaire">
								<div class="row">
									...
									<div class="col-12">
										<input type="submit" value="Envoyer un message"   id="submitBtn">
										<!-- 1°) token CSRF -->
										<!-- exemple :  <input type="hidden" name="csrf_token" value="TON_TOKEN_CSRF_ICI"> -->
										<!-- Les attaques CSRF permettent à un attaquant de soumettre un formulaire en utilisant les cookies d'un utilisateur 
										authentifié pour effectuer des actions malveillantes. Pour protéger contre cela, tu dois utiliser un token CSRF 
										dans tes formulaires.
										Sur le serveur, tu dois vérifier que le token CSRF envoyé avec la requête correspond à celui stocké côté serveur. -->
										<!-- 2°) Les attaques XSS permettent à un attaquant d'injecter du code JavaScript malveillant dans un site.
										Pour éviter cela, il est essentiel de valider et d’assainir les données envoyées par les utilisateurs.
										Il est aussi important d’utiliser les en-têtes HTTP comme
										Content-Security-Policy pour empêcher l'exécution de scripts malveillants. -->
										<!-- 3°) Les CAPTCHA ou reCAPTCHA peuvent être utilisés pour s'assurer qu'une personne réelle soumet le formulaire
										et non un bot automatisé. C'est particulièrement utile pour éviter les soumissions automatisées ou les attaques par force brute.
										<div class="g-recaptcha" data-sitekey="TA_CLE_SITE_RECAPTCHA"></div>
  										<input type="submit" value="Envoyer">
										</form>
										<script src="https://www.google.com/recaptcha/api.js" async defer></script> -->
										<!-- 4°) POUR FINIR PROTEGER DU COTE SERVEUR !!!! -->
									</div>
								</div>
							</form>
							<!-- <script>
								document.getElementById('monFormulaire').addEventListener('submit', function(event) {
								  ...
								  if (nom === "" || email === "") {
									event.preventDefault(); // Annule la soumission si un champ est vide
